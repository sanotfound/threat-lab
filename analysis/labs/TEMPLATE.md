...
What this exercise sets out to demonstrate or learn.
...
What log, network, or host artifact this activity would generate. Link to a Sigma/YARA rule in `/detection/` if one was written for this exercise.
